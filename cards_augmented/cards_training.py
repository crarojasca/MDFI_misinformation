...
data = pd.read_csv('../datasets/third_level/cards_5.3.csv')
...
model = ClassificationModel('roberta', 'roberta-large', 
                            num_labels = 19, weight = weights,
                            args={"manual_seed":seed % 2**32,
                                'reprocess_input_data': True, 
                                'overwrite_output_dir': False,
                                'output_dir': f'models/cards5.3_roberta',
                                'best_model_dir': f'models/cards5.3_roberta/best_model/',
                                # Hyperparameters
                                'train_batch_size': 6,
                                'num_train_epochs': 3, 
                                'learning_rate': 1e-5,
...
with open("models/cards5.3_roberta/best_model/" + "le.pkl", "wb") as f:
    pickle.dump(le, f)
